  ...
  return (
    <div className="project-empty-state-container">
      <div className="empty-state-card">
        ...
        <p>
          You are currently disconnected from any active agent workspaces. Open an existing project folder or configure a new one to initialize your AI team coordinator.
        </p>
        <div className="empty-state-actions">
          <button className="btn-empty-secondary" onClick={onOpenProjectSwitcher}>
            Open Existing Project
          </button>
          <button className="btn-empty-primary" onClick={onOpenCreateProject}>
